            ...
            <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
						  <select onchange="fill();" id="inventoryid" class="select2_group form-control" name="inventoryMasterID">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
						  <select onchange="fill();" id="" class="select2_group form-control" name="banerimage">
							<option value=""></option>
