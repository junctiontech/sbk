				...
				<div class="panel panel-default">					 
						<div class="panel-body">	
								...
								<form role="form" class="form-horizontal"  method="post" action="<?=base_url();?>Landingpage/compare">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label class="col-sm-5 control-label">Product 2</label>									
											<div class="col-sm-10" id="productName2">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label class="col-sm-5 control-label">Product 3</label>									
											<div class="col-sm-10" id="productName3">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label class="col-sm-5 control-label">Product 4</label>									
											<div class="col-sm-10" id="productName4">
